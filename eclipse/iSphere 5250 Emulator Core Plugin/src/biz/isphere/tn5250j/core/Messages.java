...
public class Messages extends NLS {
    ...
    public static String Session_previous_multiple;
    public static String Session_next_multiple;
    public static String Scroll_session_down;
    public static String Scroll_session_left;
    public static String Scroll_session_right;
    public static String Scroll_session_up;
    public static String Session_previous_main;
    public static String Session_next_main;
