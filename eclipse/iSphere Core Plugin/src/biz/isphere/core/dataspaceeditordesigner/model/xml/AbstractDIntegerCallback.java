...
import biz.isphere.core.dataspaceeditordesigner.model.AbstractDInteger;
import biz.isphere.core.xml.XmlParser;

public abstract class AbstractDIntegerCallback<M> extends AbstractDWidgetCallback<AbstractDInteger> {
