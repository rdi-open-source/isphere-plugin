...
public class DDecimalCallback extends AbstractDWidgetCallback<DDecimal> {
    ...
    public void doEndElement(Object userData, String path, int level, String elementData, XmlParser xmlParser) throws Exception {
        ...
        if ("/fraction".equals(path)) {
            getUserData().setFraction(xmlToInteger(elementData));
        }
    }

    @Override
    protected DDecimal getUserData() {
        return (DDecimal)super.getUserData();
    }
}
