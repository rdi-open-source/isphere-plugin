...
public final class StatusLine {
    ...
    public static final String STATUS_LINE_ID = "biz.isphere.core.ifssynchronization.rse.AbstractSynchronizeIfsFilesEditorActionBarContributor.StatusLine"; //$NON-NLS-1$
