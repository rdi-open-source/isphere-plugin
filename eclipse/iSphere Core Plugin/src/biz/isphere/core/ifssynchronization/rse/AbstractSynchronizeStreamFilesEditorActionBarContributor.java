...
public abstract class AbstractSynchronizeStreamFilesEditorActionBarContributor extends EditorActionBarContributor {

    AbstractSynchronizeStreamFilesEditor activeEditorPart;
    ...
    public void setActiveEditor(IEditorPart editorPart) {
        ...
        if (editorPart instanceof AbstractSynchronizeStreamFilesEditor) {
            activeEditorPart = (AbstractSynchronizeStreamFilesEditor)editorPart;
