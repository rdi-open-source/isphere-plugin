...
import biz.isphere.core.sourcefilesearch.SearchResultTab;
import biz.isphere.core.sourcefilesearch.SearchResultTabFolder;
...
public class XMLSearchHelper extends AbstractXmlSearchHelper {
    ...
    private static void writeSearchResult(XMLPrettyPrintWriter streamWriter, SearchResult searchResult) throws XMLStreamException {
        ...
        createNode(streamWriter, "file", searchResult.getFile());
        createNode(streamWriter, "member", searchResult.getMember());
        createNode(streamWriter, "srcType", searchResult.getSrcType());
