...
/**
 * This interface specifies the configuration of a synchronize IFS files editor.
 * 
 * @see SynchronizeStreamFilesEditor
 */
public interface ISynchronizeStreamFilesEditorConfiguration {
