...
package biz.isphere.junit.xml.sourcefilesearch;
...
public class TestXmlParserSourceFileSearch {

    public static void main(String[] args) throws Exception {

        TestXmlParserSourceFileSearch main = new TestXmlParserSourceFileSearch();
        main.testXmlParser();
    }
    ...
    public void testXmlParser() throws Exception {
        ...
        log("Testing Source File Search...\n");

        String path = getPathToXmlFile("biz/isphere/junit/xml/sourcefilesearch", "SourceFileSearchResult-v6.1.1.srcfsr");
        ...
        System.out.println("\n*** ...Source File Search successfully finished. ***");
    }
    ...
    private SearchResultTabFolder parseWithNewParser(String path) throws FileNotFoundException, XMLStreamException, XmlParserException {
        ...
        SearchResultTabFolder object1 = (SearchResultTabFolder)xmlParser.parse(new File(path), new SourceFileSearchCallback(),
