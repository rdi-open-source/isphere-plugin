...
package biz.isphere.junit.xml.streamfilesearch;
...
public class TestXmlParserStreamFileSearch {

    public static void main(String[] args) throws Exception {

        TestXmlParserStreamFileSearch main = new TestXmlParserStreamFileSearch();
        main.testXmlParser();
    }
    ...
    public void testXmlParser() throws Exception {
        ...
        log("Testing Stream File Search...\n");

        String path = getPathToXmlFile("biz/isphere/junit/xml/streamfilesearch", "StreamFileSearchResult-v6.1.1.stmfsr");
        ...
        String newObjectWritePath = new File(resourcePath, "StreamFileSearchResult-v6.1.2_new-writer.xml").getAbsolutePath();
        writeWithNewWriter(newObjectWritePath, newObject);

        String oldObjectWritePath = new File(resourcePath, "StreamFileSearchResult-v6.1.2_old-writer.xml").getAbsolutePath();
        ...
        System.out.println("\n*** ...Stream File Search successfully finished. ***");
    }
    ...
    private SearchResultTabFolder parseWithNewParser(String path) throws FileNotFoundException, XMLStreamException, XmlParserException {
        ...
        SearchResultTabFolder object1 = (SearchResultTabFolder)xmlParser.parse(new File(path), new StreamFileSearchCallback(),
